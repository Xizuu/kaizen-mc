        ...
        <div className="container max-w-4xl mx-auto px-4 py-8">
                ...
                <CardContent className="space-y-6 mt-6">
                    <div className="flex items-start justify-between">
                        <div className="space-y-2">
                            ...
                            <div
                                className="inline-block px-3 py-1 bg-yellow-900/50 rounded-md text-yellow-500 font-medium">
                                Rp{price.toLocaleString("id-ID")}
                            </div>
                        </div>
                        <div
                            className="flex items-center gap-2 bg-gradient-to-r from-yellow-400 to-yellow-500 text-black font-medium px-4 py-2 rounded-md">
            ...
            <Card className="bg-gray-800/50 border-gray-800">
                ...
                <CardContent className="space-y-6">
                    ...
                    <Button
                        className="w-full bg-yellow-400 hover:bg-yellow-500 text-black h-12 text-lg"
